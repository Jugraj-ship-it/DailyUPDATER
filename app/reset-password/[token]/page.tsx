...
import { resetPassword, type ResetPasswordState } from "@/app/actions/passwordReset";
...
export default function ResetPasswordPage() {
  ...
  const boundResetPassword = resetPassword.bind(null, params.token);
  const [state, formAction, isPending] = useActionState(boundResetPassword, initialState);
    ...
    return (
      <main className="mx-auto flex min-h-screen w-full max-w-sm flex-col justify-center px-4 py-8">
        <div className="rounded-xl border border-line bg-panel p-6 shadow-[0_18px_50px_rgba(28,38,35,0.08)]">
          <h1 className="mb-2 text-2xl font-medium">Password updated</h1>
  ...
  return (
    <main className="mx-auto flex min-h-screen w-full max-w-sm flex-col justify-center px-4 py-8">
      <div className="rounded-xl border border-line bg-panel p-6 shadow-[0_18px_50px_rgba(28,38,35,0.08)]">
        <h1 className="mb-6 text-2xl font-medium">Set a new password</h1>
